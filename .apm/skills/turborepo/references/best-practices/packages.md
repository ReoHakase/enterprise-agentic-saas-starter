...
{
  "name": "@enterprise-agentic-saas/ui",
  "exports": {
...
{
  "extends": "@enterprise-agentic-saas/typescript-config/library.json",
  "compilerOptions": {
    "outDir": "dist",
    "rootDir": "src"
  },
...
{
  "exports": {
    ".": "./src/index.ts", // @enterprise-agentic-saas/ui
    "./button": "./src/button.tsx", // @enterprise-agentic-saas/ui/button
    "./card": "./src/card.tsx", // @enterprise-agentic-saas/ui/card
    "./hooks": "./src/hooks/index.ts" // @enterprise-agentic-saas/ui/hooks
  }
}
```
...
{
  "dependencies": {
    "@enterprise-agentic-saas/ui": "workspace:*" // pnpm/bun
    // "@enterprise-agentic-saas/ui": "*"         // npm/yarn
  }
}
```
...
import { Button } from '@enterprise-agentic-saas/ui/button';
...
{
  "name": "@enterprise-agentic-saas/typescript-config",
  "exports": {
    "./base.json": "./base.json",
...
{
  "name": "@enterprise-agentic-saas/eslint-config",
  "exports": {
    "./base": "./base.js",
    "./next": "./next.js"
  },
...
```json
// pnpm/bun
{ "@enterprise-agentic-saas/ui": "workspace:*" }  // Correct

// npm/yarn
{ "@enterprise-agentic-saas/ui": "*" }            // Correct
{ "@enterprise-agentic-saas/ui": "workspace:*" }  // Wrong for npm/yarn!
```
