...
pnpm add react --filter=@enterprise-agentic-saas/ui
...
```bash
# pnpm
pnpm add lodash --filter=@enterprise-agentic-saas/utils

# npm
npm install lodash --workspace=@enterprise-agentic-saas/utils

# yarn
yarn workspace @enterprise-agentic-saas/utils add lodash
...
```bash
# pnpm
pnpm add jest --save-dev --filter=web --filter=@enterprise-agentic-saas/ui

# npm
npm install jest --save-dev --workspace=web --workspace=@enterprise-agentic-saas/ui

# yarn (v2+)
yarn workspaces foreach -R --from '{web,@enterprise-agentic-saas/ui}' add jest --dev
```
...
```bash
# pnpm
pnpm add @enterprise-agentic-saas/ui --filter=web

# This updates package.json:
{
  "dependencies": {
    "@enterprise-agentic-saas/ui": "workspace:*"
  }
}
```
