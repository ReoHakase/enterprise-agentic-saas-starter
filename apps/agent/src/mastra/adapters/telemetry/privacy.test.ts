...
import { createAgentSentryOptions } from "./privacy"

const privacyOptions = createAgentSentryOptions({})
const scrubAgentSentryEvent = privacyOptions.beforeSend
const scrubAgentSentryLog = privacyOptions.beforeSendLog
const scrubAgentSentrySpan = privacyOptions.beforeSendSpan
const filterAgentSentryIntegrations = privacyOptions.integrations
