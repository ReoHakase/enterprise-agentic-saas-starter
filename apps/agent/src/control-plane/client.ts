import {
  ...
  type AgentRunGrant,
  type AgentRunResult,
  type AgentSearchIssuesInput,
  type AgentThreadRenameResult,
  type AgentUpdateIssueActionInput,
  type AgentUsageRecordInput,
...
export type AgentInternalGateway = {
...
export const isAgentInternalControlError = (
  value: unknown
