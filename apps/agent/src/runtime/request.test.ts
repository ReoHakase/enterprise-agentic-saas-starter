import type { AgentRuntimeChatInput } from "@enterprise-agentic-saas/api/agent-client"
...
describe("private Agent runtime request", () => {
  ...
  it("rejects duplicate assets, unsafe URLs, and unbounded tool JSON", () => {
    ...
    const assistantHistory = validInput()
    assistantHistory.messages.unshift({
      id: "assistant_1",
      role: "assistant",
      parts: [
        {
    ...
    const hugeToolInput = validInput()
    hugeToolInput.messages.unshift({
      id: "assistant_2",
      role: "assistant",
      parts: [
        {
    ...
    const boundedArrayInput = validInput()
    boundedArrayInput.messages.unshift({
      id: "assistant_3",
      role: "assistant",
      parts: [
        {
    ...
    const tooManyItems = validInput()
    tooManyItems.messages.unshift({
      id: "assistant_4",
      role: "assistant",
      parts: [
        {
