/* eslint-disable */
// Generated by Wrangler by running `wrangler types --config=wrangler.images-smoke.jsonc --env-file=smoke/images/.dev.vars.example --strict-vars=false --env-interface=ImagesSmokeEnv smoke/images/cloudflare-env.d.ts` (hash: 70274ac7e63adea580eb15d2104ee6b4)
// Runtime types generated with workerd@1.20260708.1 2026-07-18 nodejs_compat
interface __BaseEnv_ImagesSmokeEnv {
...
declare namespace Cloudflare {
	...
	interface Env extends __BaseEnv_ImagesSmokeEnv {}
}
interface ImagesSmokeEnv extends __BaseEnv_ImagesSmokeEnv {}
type StringifyValues<EnvType extends Record<string, unknown>> = {
	[Binding in keyof EnvType]: EnvType[Binding] extends string ? EnvType[Binding] : string;
};
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "SMOKE_TOKEN">> {}
}
