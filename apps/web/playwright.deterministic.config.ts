...
const agentStackEnvironment = {
  ...
  SENTRY_DSN: "",
  SENTRY_ENVIRONMENT: "e2e-deterministic",
  SENTRY_RELEASE: "",
  SENTRY_SPOTLIGHT: "",
  SENTRY_TRACES_SAMPLE_RATE: "0",
  NEXT_PUBLIC_SENTRY_DSN: "",
  NEXT_PUBLIC_SENTRY_ENVIRONMENT: "e2e-deterministic",
...
const oauthStackEnvironment = {
  ...
  SENTRY_DSN: "",
  SENTRY_ENVIRONMENT: "e2e-deterministic-oauth",
  ...
  SENTRY_TRACES_SAMPLE_RATE: "0",
  NEXT_PUBLIC_SENTRY_DSN: "",
  NEXT_PUBLIC_SENTRY_ENVIRONMENT: "e2e-deterministic-oauth",
  NEXT_PUBLIC_SENTRY_ERROR_SAMPLE_RATE: "0",
  NEXT_PUBLIC_SENTRY_SPOTLIGHT: "",
  NEXT_PUBLIC_SENTRY_TRACES_SAMPLE_RATE: "0",
  NEXT_TELEMETRY_DISABLED: "1",
