...
export const createFullPlaywrightProfile = (): PlaywrightTestConfig => {
  ...
  const commonEnvironment = createAgentStackEnvironment({
    appName: "Enterprise Agentic SaaS Full E2E",
    environment,
  })
