---
name: email
description: enterprise-agentic-saas-starterのpackages/email、React Email templates、Cloudflare Email Sending、console/noop sender、SendEmail型、magic linkやinvitationのメール本文、email preview/test、auth packageとの依存境界を変更するときに使う。
---
...
packages/email/
  src/
    ...
    senders/
      ...
      noop.ts
    runtime/
      default.ts       # Bun/Node: console/noop
...
- productionでconsole senderが選択されるとfail-closedになるか。
